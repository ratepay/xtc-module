...
require_once ('../includes/modules/payment/ratepay_rate.php');
...
$smarty->assign('ownerText', RATEPAY_RATE_PDF_OWNER);
$smarty->assign('fonText', RATEPAY_RATE_PDF_FON);
$smarty->assign('faxText', RATEPAY_RATE_PDF_FAX);
$smarty->assign('emailText', RATEPAY_RATE_PDF_EMAIL);
$smarty->assign('courtText', RATEPAY_RATE_PDF_COURT);
$smarty->assign('hrText', RATEPAY_RATE_PDF_HR);
$smarty->assign('ustText', RATEPAY_RATE_PDF_UST);
$smarty->assign('bullText', RATEPAY_RATE_PDF_BULL);
$smarty->assign('accountholderText', RATEPAY_RATE_PDF_ACCOUNTHOLDER);
$smarty->assign('banknameText', RATEPAY_RATE_PDF_BANKNAME);
$smarty->assign('bankcodenumberText', RATEPAY_RATE_PDF_BANKCODENUMBER);
$smarty->assign('accountnumberText', RATEPAY_RATE_PDF_ACCOUNTNUMBER);
$smarty->assign('swiftbicText', RATEPAY_RATE_PDF_SWIFTBIC);
$smarty->assign('ibanText', RATEPAY_RATE_PDF_IBAN);
$smarty->assign('intdescText', RATEPAY_RATE_PDF_INTERNATIONALDESC);
$smarty->assign('paytransferText', RATEPAY_RATE_PDF_PAYTRANSFER);
$smarty->assign('payuntilText', RATEPAY_RATE_PDF_PAYUNTIL);
$smarty->assign('referenceText', RATEPAY_RATE_PDF_REFERENCE);
$smarty->assign('additionalText1', RATEPAY_RATE_PDF_ADDITIONALINFO_1);
$smarty->assign('additionalText2', RATEPAY_RATE_PDF_ADDITIONALINFO_2);
$smarty->assign('additionalText3', RATEPAY_RATE_PDF_ADDITIONALINFO_3);
$smarty->assign('additionalText4', RATEPAY_RATE_PDF_ADDITIONALINFO_4);
$smarty->assign('abovearticleText', RATEPAY_RATE_PDF_ABOVEARTICLE);
$smarty->assign('descriptorText', RATEPAY_RATE_PDF_DESCRIPTOR);
$smarty->assign('selectedPaymentText', RATEPAY_RATE_PDF_SELECTEDPAYMENT);
$smarty->assign('ratePdfInfo', RATEPAY_RATE_PDF_INFO);
$smarty->assign('rateReferenceNumber', RATEPAY_RATE_PDF_REFERENCENUMBER);
// End RatePAY stuff
// dont allow cache
...
$smarty->display(CURRENT_TEMPLATE . '/admin/ratepay_rate_print_order.html');