						...
						<td>
							...
							<table>
								<tr class="dataTableHeadingRow">
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=id"><b><?php echo RATEPAY_ADMIN_LOGGING_ID;?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=order_number"><b><?php echo RATEPAY_ADMIN_LOGGING_ORDER_ID;?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=transaction_id"><b><?php echo RATEPAY_ADMIN_LOGGING_TRANSACTION_ID;?></b></a></th>
                                                                        <th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=first_name"><b><?php echo 'NAME';?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=payment_method"><b><?php echo RATEPAY_ADMIN_LOGGING_PAYMENT_METHOD;?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=payment_type"><b><?php echo RATEPAY_ADMIN_LOGGING_OPERATION_TYPE;?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=	payment_subtype"><b><?php echo RATEPAY_ADMIN_LOGGING_OPERATION_SUBTYPE;?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=result"><b><?php echo RATEPAY_ADMIN_LOGGING_RESULT;?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=result_code"><b><?php echo RATEPAY_ADMIN_LOGGING_RATEPAY_RESULT_CODE;?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=result"><b><?php echo RATEPAY_ADMIN_LOGGING_RATEPAY_RESULT;?></b></a></th>
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=reason"><b><?php echo 'REASON';?></b></a></th>
									...
									<th class="dataTableHeadingContent"><a href="pi_rp_logging_xtc_modified.php?orderby=date"><b><?php echo RATEPAY_ADMIN_LOGGING_DATE;?></b></a></th>
								</tr>
								<?php
								...
								<tr class="dataTableRow">
									...
									<td class="dataTableContent"><a href="pi_rp_logging_xtc_modified.php?id=<?php echo $log['id']; ?>&type=request">Request</a></td>
									<td class="dataTableContent"><a href="pi_rp_logging_xtc_modified.php?id=<?php echo $log['id']; ?>&type=response">Response</a></td>
