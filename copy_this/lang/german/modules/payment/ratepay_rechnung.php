...
define('MODULE_PAYMENT_RATEPAY_RECHNUNG_STATUS_DESC', 'Aktivieren Sie RatePAY Rechnung');
...
define('MODULE_PAYMENT_RATEPAY_RECHNUNG_PROFILE_ID_CH_TITLE', 'Profil ID CH');
define('MODULE_PAYMENT_RATEPAY_RECHNUNG_PROFILE_ID_CH_DESC', 'Ihre von RatePAY zugewiesende ID f&uumlr die Schweiz');
define('MODULE_PAYMENT_RATEPAY_RECHNUNG_SECURITY_CODE_CH_TITLE', 'Sicherheitsschl&uuml;ssel CH');
define('MODULE_PAYMENT_RATEPAY_RECHNUNG_SECURITY_CODE_CH_DESC', 'Ihr von RatePAY zugewiesener Sicherheitsschl&uuml;ssel f&uumlr die Schweiz');
...
define('MODULE_PAYMENT_RATEPAY_RECHNUNG_MIN_CH_TITLE', 'Minimaler Bestellbetrag CH');
...
define('MODULE_PAYMENT_RATEPAY_RECHNUNG_RATEPAY_PRIVACY_URL_CH_TITLE', 'RatePAY ZGB-DSH URL CH');
define('MODULE_PAYMENT_RATEPAY_RECHNUNG_RATEPAY_PRIVACY_URL_CH_DESC', 'Zus&auml;tzliche Gesch&auml;ftsbedingungen und Datenschutzerkl&auml;rungen CH');
