...
define('RATEPAY_ORDER_RATEPAY_ADMIN_ACTION', 'Aktion');
...
define('PI_RATEPAY_ERRORTYPING','Falsche Eingabe. Eingabe wurde zur&uuml;ckgesetzt. Es d&uuml;rfen nur Zahlen eintragen werden, die den vorausgef&uuml;llten Wert nicht &uuml;berschreiten.');
