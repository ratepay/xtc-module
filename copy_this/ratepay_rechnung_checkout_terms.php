...
require_once ('lang/' . $_SESSION["language"] . '/modules/payment/ratepay_rechnung.php');
...
//XTC STANDARD END
//Assign all needed template variables and sets template
$ratepay = Loader::getRatepayPayment('ratepay_rechnung');
$ratepay->setInfoVisited(true);
...
$smarty->assign('RATEPAY_INFO_4', RATEPAY_RECHNUNG_INFO_4);
$smarty->assign('RATEPAY_INFO_5', RATEPAY_RECHNUNG_INFO_5);
$smarty->assign('RATEPAY_INFO_6', RATEPAY_RECHNUNG_INFO_6);
$smarty->assign('RATEPAY_INFO_7', RATEPAY_RECHNUNG_INFO_7);
$smarty->assign('RATEPAY_INFO_8', RATEPAY_RECHNUNG_INFO_8);
$smarty->assign('RATEPAY_INFO_9', RATEPAY_RECHNUNG_INFO_9);
$smarty->assign('RATEPAY_INFO_10', RATEPAY_RECHNUNG_INFO_10);
$smarty->assign('RATEPAY_INFO_11', RATEPAY_RECHNUNG_INFO_11);
