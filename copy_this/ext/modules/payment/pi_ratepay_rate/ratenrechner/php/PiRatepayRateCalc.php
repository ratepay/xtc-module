...
class PiRatepayRateCalc extends PiRatepayRateCalcBase{
	...
	public function getRatepayRateDetails($subtype) {
		try{
			...
			$this->setData($this->getDetailsTotalAmount(),$this->getDetailsAmount(),$this->getDetailsInterestRate(),$this->getDetailsInterestAmount(),$this->getDetailsServiceCharge(),$this->getDetailsAnnualPercentageRate(),$this->getDetailsMonthlyDebitInterest(),$this->getDetailsNumberOfRates(),$this->getDetailsRate(),$this->getDetailsLastRate());
		} catch(Exception $e){
			$this->unsetData();
			$this->setErrorMsg($e->getMessage());
		}
	...
	private function setRatepayHead($request) {
		...
		if ($this->getRequestTransactionId() != "") $head->addChild('transaction-id', $this->getRequestTransactionId());
		if ($this->getRequestTransactionShortId() != "") $head->addChild('transaction-short-id', $this->getRequestTransactionShortId());

		$operation = $head->addChild('operation', $this->getRequestOperation());

		if ($this->getRequestOperationSubtype() != "") $operation->addAttribute('subtype', $this->getRequestOperationSubtype());
	...
	private function setRatepayHeadExternal($head) {
		if($this->getRequestOrderId() != "" || $this->getRequestMerchantConsumerId() != "" || $this->getRequestMerchantConsumerClassification() != "") {
			...
			if($this->getRequestOrderId() != "") $external->addChild('order-id',$this->getRequestOrderId());
			if($this->getRequestMerchantConsumerId() != "") $external->addChild('merchant-consumer-id',$this->getRequestMerchantConsumerId());
			if($this->getRequestMerchantConsumerClassification() != "") $external->addChild('merchant-consumer-classification',$this->getRequestMerchantConsumerClassification());
		}
	}
